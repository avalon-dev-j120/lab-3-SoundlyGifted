...
public class Calculator extends JFrame{
    ...
    public Calculator() throws HeadlessException {
        ...
        line1Panel.setBorder(BorderFactory.createLineBorder(Color.BLACK, 5));
        ...
        line2Panel.setBorder(BorderFactory.createLineBorder(Color.GRAY, 5));        
        ...
        line3Panel.setBorder(BorderFactory.createLineBorder(Color.GRAY, 5));      
        ...
        line4Panel.setBorder(BorderFactory.createLineBorder(Color.GRAY, 5));            
        ...
        line5Panel.setBorder(BorderFactory.createLineBorder(Color.GRAY, 5));            
        ...
        line6Panel.setBorder(BorderFactory.createLineBorder(Color.GRAY, 5));                  
    ...
    private void adaptFontsSize(int scrHeight){
        JButton[] buttons = new JButton[]
            {buttonEq, buttonCe, buttonZero, buttonDot, buttonDiv, button1, 
        ...
        if (!"".equals(screenData.toString())){
            if (currNum == 0 && "".equals(currOperation)) {
                ...
                switch(currOperation) {
                    case "+": currNum = currNum 
                                + Double.valueOf(screenData.toString()); break;
                    case "-": currNum = currNum 
                                - Double.valueOf(screenData.toString()); break;
                    case "*": currNum = currNum 
                                * Double.valueOf(screenData.toString()); break;
                    case "/":   if (Double.valueOf(screenData.toString()) != 0){
                                currNum = currNum 
                            ...
                            break;
                    case "=": currNum = Double.valueOf(screenData.toString()); 
                                break;
                }
